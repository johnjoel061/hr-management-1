...
const RequestFormRejected = () => {
  ...
  const handleExportToExcel = () => {
    const worksheet = XLSX.utils.json_to_sheet(rejectedRequestForm);
    const workbook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(
      workbook,
      worksheet,
      "rejected Req Data Sheets"
    );
    XLSX.writeFile(workbook, "rejectedReq_data_sheets.xlsx");
  };
  ...
  return (
    <Box m="20px">
      <Header
        ...
        subtitle="List of requested certification rejected of the Local Government Unit (LGU)"
      />
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to delete this certification request rejected?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
...
export default RequestFormRejected;
